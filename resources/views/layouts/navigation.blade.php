<nav class="bg-white/95 backdrop-blur-md border-b border-gray-100/80 shadow-sm sticky top-0 z-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="flex items-center flex-1">
                    <div class="flex items-center">
                        <!-- Mobile hamburger -->
                        <button type="button"
                                class="md:hidden mr-3 inline-flex items-center justify-center rounded-lg p-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50 transition focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div class="flex items-center space-x-3">
                ...
                <a href="{{ route('messages.index') }}" class="md:hidden flex items-center justify-center w-10 h-10 bg-gray-50 text-gray-600 rounded-full hover: transition-all duration-200 hover:scale-105">
    ...
    <div class="md:hidden border-t border-gray-100 bg-white/95 backdrop-blur-md shadow-sm hidden" data-mobile-nav-panel>
        <div class="px-4 py-3 space-y-2">
            <x-nav-link :href="route('feed')" :active="request()->routeIs('feed')" class="block">
                <div class="flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-blue-50 hover:text-blue-600 transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                    </svg>
                    <span class="font-medium">{{ __('Feed') }}</span>
            ...
            <x-nav-link :href="route('search')" :active="request()->routeIs('search')" class="block">
                <div class="flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-green-50 hover:text-green-600 transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                    </svg>
                    <span class="font-medium">{{ __('Search') }}</span>
            ...
            <x-nav-link :href="route('friends.index')" :active="request()->routeIs('friends.*')" class="block">
                <div class="flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-cyan-50 hover:text-cyan-600 transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 8a3 3 0 11-6 0 3 3 0 016 0zm-9 8a3 3 0 100-6 3 3 0 000 6zm9 0a3 3 0 11-6 0 3 3 0 016 0zM15 14l1.553 1.553a2.2 2.2 0 01.647 1.557v.64A1.25 1.25 0 0116 19.75h-2.5" />
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 14l-1.553 1.553a2.2 2.2 0 00-.647 1.557v.64c0 .69.56 1.25 1.25 1.25H10" />
                    </svg>
                    <span class="font-medium">{{ __('Friends') }}</span>
                    @if($pendingFriendRequests > 0)
                        <span class="ml-auto flex h-5 min-w-[1.25rem] items-center justify-center rounded-full bg-cyan-500 px-1 text-[0.65rem] font-semibold text-white">
                            {{ $pendingFriendRequests }}
                        </span>
                    @endif
                </div>
            </x-nav-link>
            <x-nav-link :href="route('posts.create')" :active="request()->routeIs('posts.create')" class="block">
                <div class="flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-purple-50 hover:text-purple-600 transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                    </svg>
                    <span class="font-medium">{{ __('Create') }}</span>
            ...
            <x-nav-link :href="route('messages.index')" :active="request()->routeIs('messages.*')" class="block">
                <div class="flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-orange-50 hover:text-orange-600 transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h5m-5 4h8m-3 4v-2a2 2 0 00-2-2H7l-4 4V6a2 2 0 012-2h10a2 2 0 012 2v6" />
                    </svg>
                    <span class="font-medium">{{ __('Messages') }}</span>
                </div>
            </x-nav-link>
    ...
    <script>
        ...
        document.addEventListener('click', function(e) {
            ...
            if (mobilePanel && toggleButton && !e.target.closest('[data-mobile-nav-toggle]') && !e.target.closest('[data-mobile-nav-panel]')) {
